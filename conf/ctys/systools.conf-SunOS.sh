...
[ -z "$CTYS_PRTDIAG" ]&&CTYS_PRTDIAG=`getPathName $LINENO $BASH_SOURCE WARNINGEXT prtdiag /usr/sbin`
[ -z "$CTYS_PRTCONF" ]&&CTYS_PRTCONF=`getPathName $LINENO $BASH_SOURCE WARNINGEXT prtconf /usr/sbin`
